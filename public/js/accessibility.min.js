...
function MicAccessTool(A) {
    this.init = A || {
        ...
        en: {
            ...
            disable_animattions: "Website Animation ",
            access_declaration: "accessibility statement for kai portal",
            ...
            text_block: {
                header: "text size",
                btn_font_up: "increase font",
                btn_font_down: "decrease font",
                btn_font_readable: "reset font"
            },
            content_block: {
            ...
            zoom_block: {
                header: "zoom in",
                btn_cursor_white: "big white cursor",
                btn_cursor_black: "big black cursor",
                btn_zoom_in: "zoom page"
            }
        }
...
MicAccessTool.prototype.checkLanguageBox = function() {
    ...
    if (window.MICTOOLBOXAPPSTATE.keyboardRoot)
        for (var A = document.querySelectorAll("h1,h2,h3,h4,h5,h6,p,a,button,input,select,textarea"), o = 0; o < A.length; o++) A[o];
    ...
    if ("mic-toolbox-fonts-down" === this.id) {
        ...
        for (t = document.querySelectorAll("body,h1,h2,h3,h4,h5,h6,p,a,button,input,textarea,li,td,th,strong,span,blockquote,div"), i = 0; i < t.length; i++) e = t[i], c = window.getComputedStyle(e).getPropertyValue("font-size").split("px"), n = Number(c[0]), e.style.fontSize = (n / 1.1).toFixed() + "px";
        o = (o / 1.1).toFixed(2)
    }
    ...
    for (var A = document.querySelectorAll("body,h1,h2,h3,h4,h5,h6,p,a,button,input,textarea,li,td,th,strong,span,blockquote,div"), o = 0; o < A.length; o++) {
        ...
        t.style.fontSize = i, t.style.fontSize.split("px")
    }
    ...
    if (document.body.classList.contains("mic-toolbox-content-images")) {
        for (var A = document.querySelectorAll(".mic-toolbox-images-titles"), o = 0; o < A.length; o++) A[o].parentElement.removeChild(A[o]);
    ...
    for (var A = document.images, o = 0; o < A.length; o++) {
        var t, i = A[o];
        i.alt ? ((t = document.createElement("span")).className = "mic-toolbox-images-titles", t.textContent = i.alt, i.parentNode.insertBefore(t, i)) : ((t = document.createElement("span")).className = "mic-toolbox-images-titles", t.textContent = "image without text", i.parentNode.insertBefore(t, i))
    }

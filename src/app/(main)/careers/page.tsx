      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto bg-white border border-gray-300 shadow-sm">
          ...
          <div className="bg-primary text-white p-6 border-b-4 border-secondary">
            <h1 className="text-2xl font-bold uppercase tracking-wide">Careers</h1>
          </div>

          <div className="p-8 md:p-12 text-gray-800">
            <p className="mb-4">Current open positions and career opportunities will be listed here. Please check back later.</p>
          </div>
        </div>
      </div>
    </div>
